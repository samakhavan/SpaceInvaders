...
- List the four core concepts, the features they implement, and why each feature
 is an approprate use of the concept.
  Incorporate the feedback you got after
...
(save the attack() method), subtyping was the perfect answer. The hierarchy tree is as follows:
...
*I replaced my original intention of doing AI for the game with 2-D arrays--based on the feedback, I realized there would
 be no way to implement a sufficiently sophisticated AI due to the simple nature of Space Invaders as a game.
...
- Evaluate your design. Is there a good separation of functionality? How well is
 private state encapsulated?
  What would you refactor, if given the chance?
